...
<dict>
    ...
    <array>
        <dict>
            ...
            <string>com.proxygate.vpn.{client.id}</string>
            <key>PayloadUUID</key>
...
{routes_xml}
    ...
    <key>PayloadDisplayName</key>
    <string>ProxyGate VPN - {client.name}</string>
    <key>PayloadIdentifier</key>
    <string>com.proxygate.profile.{client.id}</string>
